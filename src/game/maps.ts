...
const standardVictory: VictoryCondition[] = [{ type: 'eliminate' }, { type: 'captureCapital' }];

export const maps: readonly ScenarioDefinition[] = [
  {
    id: 'skirmish', name: '緑の国境', startingGold: 6000,
    briefing: '国境地帯を制圧せよ。敵部隊の全滅、または敵司令部の占領で勝利となる。',
  ...
  },
  {
    ...
    briefing: '中央都市を足掛かりに首都包囲網を完成させ、敵を降伏させよ。',
    victoryConditions: standardVictory, defeatConditions: standardVictory,
